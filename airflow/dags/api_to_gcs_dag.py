...
api_product_to_gcs_task = PythonOperator(
    ...
    op_kwargs = {'destination_gcs_path':'fakestore/fakestore_product/fakestore_product.parquet'},
    dag = api_to_gcs_dag
)
...
api_cart_to_gcs_task = PythonOperator(
    ...
    op_kwargs = {'destination_gcs_path':'fakestore/fakestore_cart/fakestore_cart.parquet'},
    dag = api_to_gcs_dag
)
...
api_user_to_gcs_task = PythonOperator(
    ...
    op_kwargs = {'destination_gcs_path':'fakestore/fakestore_user/fakestore_user.parquet'},
    dag = api_to_gcs_dag
)
